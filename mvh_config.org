...
# 3. File with names of images to position on the grid
# 4. Height of the grid as percentage of the height of the viewport
#    (used with CSS unit vh)
# 5/6. Numbers of (a) columns and (b) rows of the grid
# 7. Grid-template-areas to specify what image to position on what
#    grid cell(s); see, e.g.:
#    https://developer.mozilla.org/en-US/docs/Web/CSS/grid-template-areas
#    With this macro, the grid areas *must* be named ga1, ga2, ...
# 8. Optional indicator whether the grid as a whole (value grid) or individual
